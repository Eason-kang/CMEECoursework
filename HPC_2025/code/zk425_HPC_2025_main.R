...
question_22 <- function() {
  ...
  # Burn-in phase
  community_max <- neutral_generation_speciation(init_community_max, speciation_rate)
  community_min <- neutral_generation_speciation(init_community_min, speciation_rate)
